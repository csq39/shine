$.extend( true, $.fn.dataTable.defaults, {
	sDom: "rt<'table-footer'<'col-sm-3'i><'col-sm-7  text-center'p><'col-sm-2  text-right'l><'clearfix'>>",
	searching: false,
    ordering: false,
	language: {
    ...
    var RayTable = function(ele, formId,settings) {
		...
		this.getColomunDefs=function(columnDef){
			iconClass={
					...
					"detail":"Hui-iconfont Hui-iconfont-edit2",
					"yulan":"faHui-iconfont Hui-iconfont-yulan",
					"finish":"Hui-iconfont Hui-iconfont-power",
					"edit":"Hui-iconfont Hui-iconfont-edit",
					"zhidu":"Hui-iconfont Hui-iconfont-yulan",
					"go":"Hui-iconfont Hui-iconfont-fabu",
					"relieve":"Hui-iconfont Hui-iconfont-del",
					"hot":"Hui-iconfont Hui-iconfont-hot"
				};
			if(!columnDef)
				columnDef = [];
			var item;
