		...
		<form class="form-horizontal" id="form" action="" method="post">
			...
			<div class="row cl mt-5">
				...
				<div class="formControls col-xs-8 col-sm-8" style="height:100%;width:700px;min-height:400px;border:1px solid #efefef">
					<div class="row cl mt-5">
						<label class="form-label col-xs-3 col-sm-3"><span class="c-red"></span>角色编码</label>
						<div class="formControls col-xs-5 col-sm-5">
							<input type="text" class="input-text radius size-S" id="roleId" name="roleId" value="${data.roleId}" disabled="disabled">
					...
					<div class="row cl mt-5">
						...
						<div class="formControls col-xs-5 col-sm-5">
							<input type="text" validata="{required:true,rangelength:[0,30]}" class="input-text radius size-S" id="roleName" name="roleName" value="${data.roleName}" >
							<span class="fa fa-check-square-o txt-danger form-control-feedback"></span>
						</div>
					</div>
					<div class="row cl mt-5">
						...
						<div class="formControls col-xs-5 col-sm-5">
							<input type="text" validata="{required:true,rangelength:[0,30],isEnglish:true}" class="input-text radius size-S" id="roleEnname" name="roleEnname" value="${data.roleEnname}" >
							<span class="fa fa-check-square-o txt-danger form-control-feedback"></span>
						</div>
					</div>
					<div class="row cl mt-5">
						...
						<div class="formControls col-xs-5 col-sm-5">
							<textarea rows="3" cols="60" validata="{rangelength:[0,60]}" class="textarea" placeholder="备注" id="remarks" name="remarks" style="width:335px;">${data.remarks}</textarea>
						</div>
					</div>
					<div class="row cl mt-5">
