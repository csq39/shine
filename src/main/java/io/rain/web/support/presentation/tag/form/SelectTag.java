...
import io.rain.core.application.SpringContextHolder;
import io.rain.core.collection.RData;
import io.rain.core.collection.RMultiData;
import io.rain.utils.string.FreeMarkers;
import io.rain.utils.string.StringUtils;
import io.rain.web.support.communal.dao.DictDao;
import io.rain.web.support.presentation.tag.CTag;
...
public class SelectTag extends CTag {
	...
	private void getOptionsByServer() {
		...
		if(!StringUtils.isEmpty(dataRoleKey)){
			items = UserUtils.getResource(dataRoleKey);
			itemLabel="name" ;
			itemValue="value";
			return;
	...
	public void setDataRoleKey(String dataRoleKey) {
		this.dataRoleKey = dataRoleKey;
	}
